...
trabecular.dvc
==============
Known-deformation apply + recover + score.

The foundation of the validation loop: impose a KNOWN displacement field on a
synthetic volume, generate the deformed volume, recover the field with the
phase-correlation DVC, and score recovered-vs-known. Because you imposed the
field, you have per-voxel ground truth -- the first honest accuracy number for
the pipeline.
...
# ---------------------------------------------------------------------------
# 2. analytic ground-truth displacement fields
# ---------------------------------------------------------------------------
